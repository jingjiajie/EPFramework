...
Public Class Configurator
    ...
    Private Sub ButtonGenerateJson_Click(sender As Object, e As EventArgs) Handles ButtonGenerateJson.Click
        If Me.ModelBoxFields.RowCount = 0 Then
    ...
    Private Sub ButtonLoad_Click(sender As Object, e As EventArgs) Handles ButtonLoad.Click
        ...
        Catch ex As Exception
            ...
            Return
        End Try
        For Each modeConfiguratioon In cfg.ModeConfigurations
            '将ModelBox切换到相应的Model
            Me.ModelBoxFields.CurrentModelName = modeConfiguratioon.Mode
            Me.ModelBoxHTTPAPIs.CurrentModelName = modeConfiguratioon.Mode
            '添加Fields配置
            Dim dataTableFields = Me.ModelBoxFields.GetDataTable
            Call dataTableFields.Rows.Clear()
            For Each curField In modeConfiguratioon.Fields
            ...
            For Each curAPI In modeConfiguratioon.HTTPAPIs
